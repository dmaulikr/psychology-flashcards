...
@interface BiologicalViewController ()

@end

@implementation BiologicalViewController
...
- (void)viewDidLoad
{
    ...
    [text setText:@"Principles of the Biological Level of Analysis"];
    ...
    [self.view setFrame:CGRectMake(0, 44, 320, 440)];
...
-(void)beginQuiz{
    ...
    QuizViewController *quizViewController = [[QuizViewController alloc]initWithLevelOfAnalysis:0];
