...
@interface SocioCulturalViewController ()

@end

@implementation SocioCulturalViewController
...
- (void)viewDidLoad
{
    ...
    [text setText:@"Principles of the SocioCultural Level of Analysis"];
...
-(void)beginQuiz{
    ...
    QuizViewController *quizViewController = [[QuizViewController alloc]initWithLevelOfAnalysis:2];
